...
// Información de las ubicaciones de los prametros de la obra
...
// Información de nivel de transito
export const niveltransito = [
  { value: '1', name: 'Nivel de transito 1' },
...
// Información de material lleno de compacto
export const materiallenocompactado = [
  { value: 'subbase', name: 'Sub base' },
  { value: 'basegranular', name: 'Base granular' },
];

// Información de tipo de resante provicional
export const tipoderasante = [
